...
export const CustomerPortalLayout = ({children, className, ...rest}) => {
  const classes = clsx('font-body', className);
        ...
        <div className="flex pb-2 mb-6 w-full">
          <h1 className="flex items-center w-full text-primary text-4xl font-title">
            ...
            <div className="ml-2 flex flex-col justify-start">
              <div>Kfone</div>
              <div className="font-display font-medium text-secondary text-sm">Self Service Portal</div>
            </div>
          </h1>
        </div>
