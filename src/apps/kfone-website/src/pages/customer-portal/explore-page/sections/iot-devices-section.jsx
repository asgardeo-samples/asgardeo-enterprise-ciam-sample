    ...
    <section>
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">IoT devices</h2>
          <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
            Our devices are designed to work specifically on our IoT SIMs and deliver unique capabilities that will
            allow you to scale quickly, save money and deploy globally with confidence.
          </p>
        </div>
