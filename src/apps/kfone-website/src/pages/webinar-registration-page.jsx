          ...
          <div className="container mx-auto space-y-16">
            <section className="mt-16">
              <span className="block mb-2 text-xs font-medium tracking-widest uppercase lg:text-center text-secondary-900">
                Grow Your Business with <span className="font-title">Kfone</span> • Exclusive Webinar Series
              </span>
              <h2 className="text-4xl lg:text-center text-secondary-700">Register Now for Upcoming Webinar!</h2>
            </section>
