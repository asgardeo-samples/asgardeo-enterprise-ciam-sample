...
export const Footer = ({className, ...rest}) => {
  const classes = clsx('bg-light mt-10 text-secondary-900 pt-10', className);
    ...
    <footer className={classes} {...rest}>
      ...
      <div className="flex justify-center items-center bg-black">
        <h6 className="text-secondary-100 font-light text-[10px] py-2">
          Copyright &copy; {new Date().getFullYear()} Kfone Telecommunications Inc. All rights reserved.
        </h6>
      </div>
    </footer>
  );
