...
import {HeaderTitle, VerticalCard} from '..';
import clsx from 'clsx';

export const DealsSection = ({className, ...rest}) => {
  const classes = clsx('md:px-10 grid grid-cols-1 md:grid-cols-2 gap-2 items-center bg-light p-4', className);
  ...
  return (
    <div className={classes} {...rest}>
      ...
      <VerticalCard
        ...
        className="text-white bg-black rounded-lg m-4 shadow-slate-600 shadow-lg transition ease-in-out delay-150 hover:scale-105 duration-300"
      />
      <VerticalCard
        ...
        className="text-black bg-[#E9E3DB] rounded-lg m-4 shadow-brown-300 shadow-lg transition ease-in-out delay-150 hover:scale-105 duration-300"
      />
    </div>
  );
};
