...
import {HeaderTitle, PrimaryButton} from '..';
import clsx from 'clsx';

export const UnlimitedPlansSection = ({className, ...rest}) => {
  const classes = clsx('md:px-10 grid grid-cols-1 md:grid-cols-2 gap-2 items-start bg-white mt-10 p-4', className);
    ...
    >
      ...
      <div className="flex flex-col h-full justify-between text-secondary text-left">
        <div className="py-2">
          ...
          <h6 className="text-lg font-light text-secondary-600">Pick the perfect plan for you with flexible options</h6>
          <ul className="mt-4">
        ...
        <div className="py-4">
          <p className="mb-10">
            Enjoy unlimited talk and text. Customers who bring their own device get free shipping with all orders and a
            free SIM.
          </p>
          <PrimaryButton endIcon={<BsArrowRightShort size={28} />}>Shop Unlimited</PrimaryButton>
        </div>
      </div>
    </section>
  );
