...
export const ResourcesSection = ({className, ...rest}) => {
  const classes = clsx('mt-16', className);
  ...
  return (
    <section className={classes}>
      ...
      <p className="text-sm max-w-2xl mx-auto my-5 text-center text-secondary-600">
        Here are some resources to learn and grow your venture with our expertise gained by working with over thousands
        of small to large scaled businesses for the past 20 years. We gladly share these resources with you to help to
