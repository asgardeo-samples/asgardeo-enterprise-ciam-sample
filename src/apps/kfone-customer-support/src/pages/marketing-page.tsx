...
import {PrimaryButton, PreLoader} from '../components';
...
/**
 * The props for the Marketing Page component.
 */
export type MarketingPageProps = DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>;

/**
 * Marketing page component.
 *
 * @returns The Marketing Page component.
 */
export const MarketingPage: FC<MarketingPageProps> = (): ReactElement => {
  ...
  const handleOnChange = (position: number) => {
    ...
    updatedCheckedState.forEach(checkBoxValue => {
        ...
        <DashboardLayout>
          <div className="mt-3 mb-10">
            <div className="flex justify-between">
              <div className="flex">
                <div className="relative inline-block text-left w-58 mr-5">
                  <button
                    type="button"
                    className={
                      'inline-flex w-60 justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm ' +
                ...
                <PrimaryButton className="right-2.5 bottom-2.5" onClick={retrieveInteractions}>
                  {isUserInfoLoading && (
                    <svg
                      role="status"
              ...
              <PrimaryButton disabled={isUserInfoLoading || isUserInfoError || !userInfo} onClick={sendEmail}>
          ...
          {isSentEmail && (
            <div
              className={
                'absolute right-5 bottom-10 flex items-center p-4 space-x-4 w-full max-w-xs text-gray-500 bg-white ' +
                'rounded-lg divide-x divide-gray-500 shadow-lg space-x'
              }
              role="alert"
            >
              <svg
                                ...
                                <td className="p-4 w-4">
                                  <div className="flex items-center">
                                    <input
                                      ...
                                      type="checkbox"
                                      className={
                                        'w-4 h-4 text-blue-600 bg-gray-100 rounded ' +
