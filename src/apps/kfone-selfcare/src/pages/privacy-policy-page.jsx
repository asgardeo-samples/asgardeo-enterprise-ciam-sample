...
export const PrivacyPolicyPage = () => {
  return (
    <div className="font-body max-w-md text-sm p-4">
      ...
      <p>
        At kfone.life, accessible from https://kfone.life, one of our main priorities is the privacy of our visitors.
        This Privacy Policy document contains types of information that is collected and recorded by kfone.life and how
        we use it.
      </p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in kfone.life. This policy is not applicable to any
      ...
      <p>
        kfone.life follows a standard procedure of using log files. These files log visitors when they visit websites.
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of kfone.life.</p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on kfone.life, which are sent directly to users&apos;
      ...
      <p>
        Note that kfone.life has no access to or control over these cookies that are used by third-party advertisers.
      </p>

      <h2 className="font-bold">Third Party Privacy Policies</h2>

      <p>
        kfone.life&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
      ...
      <p>
        kfone.life does not knowingly collect any Personal Identifiable Information from children under the age of 13.
